...
#img = np.array(Image.open("ds.png"))
#fig2 = px.imshow(img)
...
app.layout = html.Div(children=[
    ...
    html.Img(src=app.get_asset_url("ds.png"), alt="Uma Imagem"),
    html.Hr(),
    ...
    html.P("Informe a quantidade de pessoas na equipe para este projeto"),
    dcc.Input(id="1", type="text"),
    html.Br(),
    
    html.P("Informe a quantidade de tarefas executas por dia"),
    dcc.Slider(0,20,5, value = 10),
    html.Br(),

    html.P("Informe o tipo de gestão que será utilizado"),
    dcc.Checklist(
        ['Scrum', 'Agile']
    ),
